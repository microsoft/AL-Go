...
| <a id="failOnNewWarnings"></a>failOnNewWarnings | If failOnNewWarnings is set to true, pull requests will fail if new warnings are introduced. Note that this will only work if enableCodeCop is set to true. | false |
