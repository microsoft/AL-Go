...
| <a id="doNotPerformUpgrade"></a>doNotPerformUpgrade | When true, the pipeline will not perform the upgrade phase in Run-AlPipeline. Use this when you want to publish and test without running upgrade logic against previous apps. | false |
