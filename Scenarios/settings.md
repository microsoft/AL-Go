...
| <a id="failOnNewWarnings"></a>failOnNewWarnings | If failOnNewWarnings is set to true, AL-Go will download the last successful reference build and compare warnings in the pull request to warnings on the reference build. If new warnings are added, the pull request will fail. This setting only has effect if enableCodeCop is set to true. | false |
