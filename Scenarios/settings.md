...
| <a id="trackCodeCopIssuesInGitHub"></a>trackCodeCopIssuesInGitHub | If trackCodeCopIssuesInGitHub is set to true, AL code analysis results will be uploaded and tracked in the GitHub security tab. Additionally, if Advanced Security is enabled in the repo, new AL code alerts will be posted in PRs that introduce them | false |
