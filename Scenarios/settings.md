...
is a structure defining `EndPoint`, `Account` and `CertificateProfile` if you want to use trusted signing. Your Azure Credentials secret still needs to provide access to your Azure Subscription using a managed identity or a Microsoft Entra ID App.
