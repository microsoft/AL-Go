...
| <a id="commitMessageSuffix"></a>commitMessageSuffix | If you want AL-Go to include a particular message in commits and pull requests opened by AL-Go you can specify a `commitMessageSuffix`.  |
