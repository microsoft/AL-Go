...
| <a id="CICDPullrequestTrigger"></a>CICDPullrequestTrigger | Setting for specifying the trigger Al-Go should use to trigger Pull Request Builds. By default it is set to [pull_request_target](https://docs.github.com/en/actions/using-workflows/events-that-trigger-workflows#pull_request_target) |
