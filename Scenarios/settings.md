...
| <a id="incrementalBuilds"></a>incrementalBuilds | Structure with properties controlling partial builds during CI/CD, which holds the following properties:<br />**Enabled** Enabled?<br />**RetentionDays** retention days<br />**Mode** mode |
