...
CreateAlGoRepository `
    ...
    -contentScript {
        Param([string] $path)
        $global:id2 = CreateNewAppInFolder -folder $path -name app2 -publisher "MS Test" -objID 50002
        $global:id1 = CreateNewAppInFolder -folder $path -name app1 -publisher "MS Test" -objID 50001 -dependencies @( @{ "id" = $global:id2; "name" = "app2"; "publisher" = "MS Test"; "version" = "1.0.0.0" } )
        $global:id3 = CreateNewAppInFolder -folder $path -name app3 -publisher "MS Test" -objID 50003 -dependencies @( @{ "id" = $global:id1; "name" = "app1"; "publisher" = "MS Test"; "version" = "1.0.0.0" }, @{ "id" = $global:id2; "name" = "app2"; "publisher" = "MS Test"; "version" = "1.0.0.0" } )
...
CreateAlGoRepository `
    ...
    -contentScript {
        Param([string] $path)
        $global:id4 = CreateNewAppInFolder -folder $path -name app4 -publisher "MS Test" -objID 50004 -dependencies @( @{ "id" = $global:id1; "name" = "app1"; "publisher" = "MS Test"; "version" = "1.0.0.0" } )
...
CreateAlGoRepository `
    ...
    -contentScript {
        Param([string] $path)
        $global:id5 = CreateNewAppInFolder -folder $path -name app5 -publisher "MS Test" -objID 50005 -dependencies @( @{ "id" = $global:id4; "name" = "app4"; "publisher" = "MS Test"; "version" = "1.0.0.0" }; @{ "id" = $global:id3; "name" = "app3"; "publisher" = "MS Test"; "version" = "1.0.0.0" } )
        Add-PropertiesToJsonFile -path (Join-Path $path '.AL-Go\settings.json') -properties @{ "country" = "dk" }
    }
