...
# test artifacts generated in common repo
Test-ArtifactsFromRun -runid $commonRun.id -folder 'artifacts' -expectedArtifacts @{"Apps"=3;"TestApps"=0;"Dependencies"=0} -repoVersion '1.0' -appVersion '1.0'

# Wait for CI/CD workflow of W1 to finish
Set-Location $w1RepoPath
$w1Run = Run-CICD -repository $w1Repository -branch $branch -wait

# test artifacts generated in W1 repo
