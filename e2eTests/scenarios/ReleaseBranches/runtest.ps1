...
Test-LogContainsFromRun -runid $run.id -jobName 'Build . - Default BuildALGoProject' -stepName 'Run pipeline' -expectedText "Using $ver1 (tag $tag1) as previous release"
...
Test-LogContainsFromRun -runid $run.id -jobName 'Build . - Default BuildALGoProject' -stepName 'Run pipeline' -expectedText "Using $ver2 (tag $tag2) as previous release"
...
Test-LogContainsFromRun -runid $runRelease1.id -jobName 'Build . - Default BuildALGoProject' -stepName 'Run pipeline' -expectedText "Using $ver1 (tag $tag1) as previous release"
...
Test-LogContainsFromRun -runid $runRelease2.id -jobName 'Build . - Default BuildALGoProject' -stepName 'Run pipeline' -expectedText "Using $ver2 (tag $tag2) as previous release"
...
Test-LogContainsFromRun -runid $runRelease1.id -jobName 'Build . - Default BuildALGoProject' -stepName 'Run pipeline' -expectedText "Using $hotVer1 (tag $hotTag1) as previous release"
