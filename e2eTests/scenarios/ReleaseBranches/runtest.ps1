...
# Check that no previous release was found
Test-LogContainsFromRun -runid $run.id -jobName 'Build . - Default' -stepName 'Build AL Project' -expectedText 'No previous release found'
...
Test-LogContainsFromRun -runid $run.id -jobName 'Build . - Default' -stepName 'Build AL Project' -expectedText "Using $ver1 (tag $tag1) as previous release"
...
Test-LogContainsFromRun -runid $run.id -jobName 'Build . - Default' -stepName 'Build AL Project' -expectedText "Using $ver2 (tag $tag2) as previous release"
...
Test-LogContainsFromRun -runid $runRelease1.id -jobName 'Build . - Default' -stepName 'Build AL Project' -expectedText "Using $ver1 (tag $tag1) as previous release"
...
Test-LogContainsFromRun -runid $runRelease2.id -jobName 'Build . - Default' -stepName 'Build AL Project' -expectedText "Using $ver2 (tag $tag2) as previous release"
...
Test-LogContainsFromRun -runid $runRelease1.id -jobName 'Build . - Default' -stepName 'Build AL Project' -expectedText "Using $hotVer1 (tag $hotTag1) as previous release"
