...
- Issue 2070 Support public GitHub Packages feeds without requiring a Personal Access Token (PAT): public GitHub Packages feeds can now be read using the GITHUB_TOKEN (with read:packages permissions). A PAT is still required for publishing packages or accessing private GitHub Packages feeds.
