Describe "AL-Go-Helper tests" {
    ...
    It 'ResolveProjectFolders' {
        ...
        try {
            ...
            # Test: ResolveProjectFolders with no app folders specified, scan all folders and finds them
            ...
            # Test: ResolveProjectFolders with only appFolders specified, scan only app folders and finds them
            ...
            # Test: ResolveProjectFolders with only appFolders specified, scan only app folders and finds only the once that exist
            $projectSettings = @{ 'appFolders' = @('nonExistingApp', 'app1'); 'testFolders' = @(''); 'bcptTestFolders' = @()}
