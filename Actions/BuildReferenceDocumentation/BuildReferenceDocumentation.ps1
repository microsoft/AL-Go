...
foreach($release in $releases) {
    ...
    try {
        ...
        $allApps = CalculateProjectsAndApps -tempFolder $tempFolder -projects $projects -excludeProjects $excludeProjects
...
$allApps = CalculateProjectsAndApps -tempFolder $artifactsFolder -projects $projects -excludeProjects $excludeProjects
$releaseNotes = ''
if ($latestReleaseTag) {
    try {
