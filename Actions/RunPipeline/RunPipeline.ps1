...
try {
    ...
    Write-Host "Code sign certificate secret name: $($settings.codeSignCertificateSecretName)"
    if (!$repo.doNotSignApps -and $codeSignCertificateUrl -and $codeSignCertificatePassword -and !$settings.codeSignCertificateSecretName) {
