...
$defaultBcContainerHelperVersion = "https://github.com/mazhelez/navcontainerhelper/zipball/run-cops-test-apps" # Must be double quotes. Will be replaced by BcContainerHelperVersion if necessary in the deploy step
