...
function ReadSettings {
    ...
    $settings = [ordered]@{
        ...
        "ALDoc"                                         = [ordered]@{
            ...
            "Footer"                                    = "Documentation for [{REPOSITORY}](https://github.com/{REPOSITORY}) made with <a href=""https://aka.ms/AL-Go"">AL-Go for GitHub</a>, <a href=""https://go.microsoft.com/fwlink/?linkid=2247728"">ALDoc</a> and <a href=""https://dotnet.github.io/docfx"">DocFx</a>"
